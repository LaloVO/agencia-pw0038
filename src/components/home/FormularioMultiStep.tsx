...
export default function FormularioMultiStep({ onSubmitComplete }: FormularioMultiStepProps) {
  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-4 md:px-0">
      ...
      <div className="bg-[#07192A]/40 backdrop-blur-md border border-white/10 rounded-full px-6 py-4 shadow-elegant flex items-center justify-between overflow-x-auto gap-4">
        {STEPS.map((step, idx) => {
            ...
            <React.Fragment key={step.id}>
              <div className="flex flex-col items-center shrink-0">
                ...
                <span className={`text-[10px] md:text-xs mt-1.5 font-sans font-medium hidden md:block
                  ${isCurrent ? "text-white font-semibold" : "text-[#9BB0C1]/60"}
                `}>
                  {step.title}
                </span>
              </div>
      ...
      <div className="bg-[#07192A]/30 backdrop-blur-lg border border-white/10 rounded-3xl p-6 md:p-10 shadow-elegant mt-8 min-h-[460px] relative transition-all duration-300">
        
        {/* PASO 1: Información Personal */}
        {currentStep === 1 && (
          <div className="space-y-6 animate-fadeIn">
            <div className="text-center mb-8">
              <h2 className="font-sans text-3xl text-white font-medium">Información Personal</h2>
              <p className="font-sans text-sm text-[#9BB0C1] mt-2">
            ...
            <div className="space-y-5 max-w-lg mx-auto">
              <div className="space-y-2">
                <Label htmlFor="nombreCompleto" className="font-sans text-sm font-medium text-white flex items-center gap-2">
                  <User className="w-4 h-4 text-[#C09A6F]" />
                  Nombre Completo *
                </Label>
                <Input
                  id="nombreCompleto"
                  ...
                  className={`rounded-full bg-[#07192A]/50 backdrop-blur-md/5 border-white/10 focus:bg-[#07192A]/50 backdrop-blur-md/10 text-white focus:border-[#C09A6F] focus:ring-0 ${
              ...
              <div className="space-y-2">
                <Label htmlFor="email" className="font-sans text-sm font-medium text-white flex items-center gap-2">
                  <Mail className="w-4 h-4 text-[#C09A6F]" />
                  Correo Electrónico *
                </Label>
                <Input
                  id="email"
              ...
              <div className="space-y-2">
                <Label htmlFor="telefono" className="font-sans text-sm font-medium text-white flex items-center gap-2">
                  <Phone className="w-4 h-4 text-[#C09A6F]" />
                  Teléfono Móvil *
                </Label>
                <Input
                  id="telefono"
        ...
        {currentStep === 2 && (
          <div className="space-y-6 animate-fadeIn">
            <div className="text-center mb-8">
              <h2 className="font-sans text-3xl text-white font-medium">Características del Inmueble</h2>
              <p className="font-sans text-sm text-[#9BB0C1] mt-2">
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
              ...
              <div className="space-y-3">
                <Label className="font-sans text-sm font-medium text-white flex items-center gap-2">
                  <Home className="w-4 h-4 text-[#C09A6F]" />
                    ...
                    <Label
                      ...
                      className={`flex-1 cursor-pointer border rounded-2xl p-4 flex flex-col justify-between h-20 transition-all duration-300
                        ${watch("tipoOperacion") === "compra" 
                          ? "bg-[#07192A]/50 backdrop-blur-md border-[#C09A6F] shadow-elegant scale-[1.02]" 
                          : "bg-[#07192A]/40 border-white/5 hover:bg-[#07192A]/50 backdrop-blur-md/60"
                        }
                      `}
                    >
                      <span className="font-sans font-semibold text-sm text-white">Comprar</span>
                      <span className="text-[10px] text-[#9BB0C1] mt-1">Adquirir propiedad en patrimonio</span>
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2 flex-1">
                    ...
                    <Label
                      ...
                      `}
                    >
                      <span className="font-sans font-semibold text-sm text-white">Rentar</span>
                      <span className="text-[10px] text-[#9BB0C1] mt-1">Arrendamiento de residencia exclusiva</span>
                    </Label>
                  </div>
                </RadioGroup>
              </div>
              ...
              {/* Tipo de Propiedad */}
              <div className="space-y-2">
                <Label htmlFor="tipoPropiedad" className="font-sans text-sm font-medium text-white">
                  Tipo de Propiedad *
                </Label>
                <Select
                ...
                >
                  <SelectTrigger className={`rounded-full bg-[#07192A]/50 backdrop-blur-md/5 border-white/10 focus:bg-[#07192A]/50 backdrop-blur-md/10 text-white focus:ring-0 ${
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="space-y-2">
                  <Label className="font-sans text-xs font-medium text-[#9BB0C1] flex items-center gap-1.5">
                    <BedDouble className="w-3.5 h-3.5 text-[#C09A6F]" />
                    Habitaciones
                  </Label>
                  <Select
                  ...
                  >
                    <SelectTrigger className="rounded-full bg-[#07192A]/50 backdrop-blur-md/5 border-white/10">
                ...
                <div className="space-y-2">
                  <Label className="font-sans text-xs font-medium text-[#9BB0C1] flex items-center gap-1.5">
                    <Car className="w-3.5 h-3.5 text-[#C09A6F]" />
                    Estacionamientos
                  </Label>
                  <Select
              ...
              <div className="space-y-2">
                <Label className="font-sans text-sm font-medium text-white flex items-center gap-2">
                  <Maximize className="w-4 h-4 text-[#C09A6F]" />
        ...
        {currentStep === 3 && (
          <div className="space-y-6 animate-fadeIn">
            <div className="text-center mb-6">
              <h2 className="font-sans text-3xl text-white font-medium">Ubicación y Estilo de Vida</h2>
              <p className="font-sans text-sm text-[#9BB0C1] mt-2">
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
              ...
              <div className="space-y-3">
                <Label className="font-sans text-sm font-medium text-white flex items-center gap-2">
                  <MapPin className="w-4 h-4 text-[#C09A6F]" />
                  Estados de Interés *
                </Label>
                <div className="flex gap-2">
                  <select
                    ...
                    className="flex-1 h-10 rounded-full border border-white/10 bg-[#07192A]/50 backdrop-blur-md/5 px-4 py-2 text-sm font-sans focus:bg-[#07192A]/50 backdrop-blur-md/10 text-white focus:border-[#C09A6F]"
                  >
                  ...
                  <Button
                    ...
                    className="rounded-full bg-[#C09A6F] hover:bg-[#A07B53]"
                  >
                    Agregar
                  </Button>
                </div>
                <div className="flex flex-wrap gap-2 min-h-[30px]">
                  {estadosDeseados.map((estado: string) => (
                    <Badge key={estado} variant="secondary" className="rounded-full px-3 py-1 font-sans bg-[#07192A]/50 backdrop-blur-md border border-white/10 text-white flex items-center gap-1.5">
                      {estado}
                      <button
                        type="button"
              ...
              {/* Ciudades Deseadas */}
              <div className="space-y-3">
                <Label className="font-sans text-sm font-medium text-white">Ciudades o Municipios Específicos</Label>
                <div className="flex gap-2">
                  <Input
                    value={ciudadInput}
                    ...
                    className="rounded-full bg-[#07192A]/50 backdrop-blur-md/5 border-white/10 focus:bg-[#07192A]/50 backdrop-blur-md/10 text-white focus:border-[#C09A6F]"
                  />
                  <Button
                    type="button"
                ...
                <div className="flex flex-wrap gap-2 min-h-[30px]">
                  {ciudadesDeseadas.map((ciudad: string) => (
                    <Badge key={ciudad} variant="secondary" className="rounded-full px-3 py-1 font-sans bg-[#07192A]/50 backdrop-blur-md border border-white/10 text-white flex items-center gap-1.5">
                      {ciudad}
                      <button
                        type="button"
              ...
              {/* Zonas Específicas */}
              <div className="space-y-2">
                <Label htmlFor="zonasEspecificas" className="font-sans text-sm font-medium text-white">
              ...
              <div className="space-y-3 bg-[#0B1C28]/60 border border-[#C09A6F]/25 rounded-2xl p-5 md:p-6 shadow-card">
                <Label htmlFor="estiloVidaDescripcion" className="font-sans text-white font-medium text-base flex items-center gap-2">
                  <Heart className="w-5 h-5 text-red-500 fill-red-500/20" />
                  Describe tu Estilo de Vida y Necesidades Diarias *
                </Label>
                <p className="text-xs text-[#9BB0C1] leading-relaxed">
                ...
                <Textarea
                  ...
                  className={`bg-[#07192A]/50 backdrop-blur-md/10 border-white/10 focus:bg-[#07192A]/50 backdrop-blur-md/10 text-white focus:border-[#C09A6F] focus:ring-0 rounded-2xl ${
                    errors.estiloVidaDescripcion ? "border-red-500" : ""
                  }`}
                />
                <div className="flex items-center justify-between text-[11px] text-[#9BB0C1]">
        ...
        {currentStep === 4 && (
          <div className="space-y-6 animate-fadeIn">
            <div className="text-center mb-8">
              <h2 className="font-sans text-3xl text-white font-medium">Presupuesto y Financiamiento</h2>
              <p className="font-sans text-sm text-[#9BB0C1] mt-2">
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
              ...
              <div className="bg-[#0B1C28]/60 border border-white/5 rounded-2xl p-5 md:p-6 shadow-card space-y-4">
                <Label className="font-sans text-base font-semibold text-white flex items-center gap-2">
                  <DollarSign className="w-5 h-5 text-[#C09A6F]" />
                  Rango de Presupuesto (Pesos Mexicanos MXN) *
                </Label>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <Label htmlFor="presupuestoMin" className="font-sans text-xs text-[#9BB0C1]">Presupuesto Mínimo</Label>
                    <div className="relative">
                      <span className="absolute left-3 top-1/2 -translate-y-1/2 text-[#9BB0C1] text-sm">$</span>
                      <Input
                        id="presupuestoMin"
                        type="text"
                        ...
                        className={`rounded-full pl-7 bg-[#07192A]/50 backdrop-blur-md/5 border-white/10 focus:bg-[#07192A]/50 backdrop-blur-md/10 text-white focus:border-[#C09A6F] focus:ring-0 ${
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="presupuestoMax" className="font-sans text-xs text-[#9BB0C1]">Presupuesto Máximo</Label>
                    <div className="relative">
                      <span className="absolute left-3 top-1/2 -translate-y-1/2 text-[#9BB0C1] text-sm">$</span>
                      <Input
                        id="presupuestoMax"
              ...
              <div className="space-y-3">
                <Label className="font-sans text-sm font-medium text-white flex items-center gap-2">
                  <CreditCard className="w-4 h-4 text-[#C09A6F]" />
                ...
                <div className="space-y-3">
                  {METODOS_PAGO.map((metodo) => (
                    <div
                      key={metodo.id}
                      className="flex items-start space-x-3 p-4 bg-[#07192A]/50 backdrop-blur-md/5 border border-white/5 rounded-2xl hover:bg-[#07192A]/50 backdrop-blur-md transition-colors duration-300 cursor-pointer shadow-card"
                    ...
                    >
                      <Checkbox
                        ...
                        className="mt-0.5 border-[#C09A6F]/40 data-[state=checked]:bg-[#C09A6F] data-[state=checked]:border-[#C09A6F]"
                      />
                      <div className="flex-1">
                        <Label htmlFor={metodo.id} className="font-sans font-medium text-sm text-white cursor-pointer">
                          {metodo.label}
                        </Label>
                        <p className="text-xs text-[#9BB0C1] mt-0.5">{metodo.description}</p>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="bg-[#07192A]/40 border border-white/5 rounded-2xl p-5 shadow-card space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                    <Label htmlFor="tienePrecalificacion" className="font-sans font-medium text-white">
                      ¿Cuentas con una Precalificación Crediticia?
                    </Label>
                    <p className="text-xs text-[#9BB0C1] mt-0.5">
                  ...
                  <Switch
                    ...
                    className="data-[state=checked]:bg-[#C09A6F]"
                  />
                </div>

                {watch("tienePrecalificacionCrediticia") && (
                  <div className="space-y-2 animate-slideDown">
                    <Label htmlFor="institucionCrediticia" className="font-sans text-xs text-[#9BB0C1]">
        ...
        {currentStep === 5 && (
          <div className="space-y-6 animate-fadeIn">
            <div className="text-center mb-8">
              <h2 className="font-sans text-3xl text-white font-medium">Uso del Inmueble</h2>
              <p className="font-sans text-sm text-[#9BB0C1] mt-2">
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
              <div className="space-y-3">
                <Label className="font-sans text-sm font-medium text-white">¿Cuál será el uso de destino principal? *</Label>
                <RadioGroup
                        ...
                        <Label
                          ...
                          className={`flex-1 cursor-pointer border rounded-2xl p-4 flex gap-4 items-center transition-all duration-300 shadow-card
                            ${watch("usoDestino") === opc.id
                              ? "bg-[#07192A]/50 backdrop-blur-md border-[#C09A6F] scale-[1.01]"
                              : "bg-[#07192A]/40 border-white/5 hover:bg-[#07192A]/50 backdrop-blur-md/60"
                            }
                          `}
                        >
                          <div className="bg-[#0B1C28] p-2.5 rounded-xl border border-white/5 text-[#C09A6F]">
                            <Icon className="w-5 h-5" />
                          </div>
                          <div>
                            <span className="font-sans font-semibold text-sm text-white">{opc.label}</span>
                            <span className="block text-[11px] text-[#9BB0C1] mt-0.5">{opc.description}</span>
                          </div>
                        </Label>
                      </div>
                    );
              ...
              {/* Detalles del Uso */}
              <div className="space-y-2">
                <Label htmlFor="detallesUso" className="font-sans text-sm font-medium text-white">
                ...
                <Textarea
                  ...
                  className="bg-[#07192A]/50 backdrop-blur-md/5 border-white/10 focus:bg-[#07192A]/50 backdrop-blur-md/10 text-white focus:border-[#C09A6F] focus:ring-0 rounded-2xl"
                />
              </div>
            </div>
          </div>
        ...
        {currentStep === 6 && (
          <div className="space-y-6 animate-fadeIn">
            <div className="text-center mb-8">
              <h2 className="font-sans text-3xl text-white font-medium">Expediente de Documentos</h2>
              <p className="font-sans text-sm text-[#9BB0C1] mt-2">
            ...
            <div className="space-y-6 max-w-2xl mx-auto">
              ...
              <div className="bg-[#07192A]/50 backdrop-blur-md rounded-2xl p-6 border border-white/10 shadow-card hover:border-[#C09A6F]/30 transition-all duration-300 space-y-4">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex-1 space-y-1">
                    <h3 className="font-sans text-base font-semibold text-white flex items-center gap-2">
                      <Calendar className="w-5 h-5 text-[#C09A6F]" />
                ...
                {citaVirtualSolicitada && (
                  <div className="pt-4 border-t border-white/5 space-y-4 animate-fadeIn">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {/* Selector de Fecha */}
                      <div className="space-y-2">
                        <Label className="text-xs font-semibold text-[#9BB0C1]">Selecciona la Fecha de tu Cita</Label>
                        <input
                          type="date"
                          ...
                          className="w-full h-10 rounded-full border border-white/10 bg-[#07192A]/50 backdrop-blur-md px-4 text-sm font-sans focus:border-[#C09A6F] focus:outline-none"
                        />
                      </div>

                      {/* Selector de Horario */}
                      <div className="space-y-2">
                        <Label className="text-xs font-semibold text-[#9BB0C1]">Selecciona la Hora (Sesión de 1 hora)</Label>
                        {citaVirtualFecha ? (
                          isLoadingBusySlots ? (
                            <div className="h-10 flex items-center justify-center text-xs text-[#9BB0C1]/60">
                              <Loader2 className="w-4 h-4 mr-2 animate-spin text-[#C09A6F]" />
                          ...
                          <div className="h-10 flex items-center justify-center border border-dashed border-white/10 rounded-full text-xs text-[#9BB0C1]/60 bg-transparent">
              ...
              <div className="bg-[#0B1C28]/60 border border-white/5 rounded-2xl p-5 md:p-6 shadow-card space-y-4">
                <h3 className="font-sans text-base font-semibold text-white flex items-center gap-2">
                  <FileText className="w-5 h-5 text-[#C09A6F]" />
                ...
                <div className="space-y-3">
                  {TIPOS_DOCUMENTOS.map((doc) => {
                    ...
                    return (
                      <div
                        key={doc.id}
                        className="bg-[#07192A]/50 backdrop-blur-md rounded-2xl p-4 border border-white/10 flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-card hover:border-[#C09A6F]/30 transition-all duration-300"
                      >
                        <div className="flex items-center gap-3">
                          {uploadingDocs[doc.id] ? (
                            <Loader2 className="w-5 h-5 text-[#C09A6F] animate-spin shrink-0" />
                          ) : isUploaded ? (
                          ...
                          <div>
                            ...
                            {uploadingDocs[doc.id] ? (
                              <span className="text-[10px] text-[#C09A6F] font-sans font-medium animate-pulse">Subiendo a base de datos...</span>
                            ) : isUploaded ? (
                        ...
                        <div className="shrink-0 flex items-center gap-3">
                          <Button
                            ...
                            className={`rounded-full font-sans text-xs border-white/10 hover:bg-[#0B1C28] hover:text-[#C09A6F] ${
              ...
              {/* Nota de Alerta */}
              <div className="bg-[#0B1C28] border border-[#C09A6F]/20 rounded-2xl p-5 flex gap-3 shadow-card">
                <AlertCircle className="w-5 h-5 text-[#C09A6F] shrink-0 mt-0.5" />
                <div className="text-xs text-[#9BB0C1] leading-relaxed">
                  <p className="font-sans font-semibold text-white mb-1">Políticas de Privacidad e Integridad:</p>
                  <p>
      ...
      <div className="flex justify-between items-center mt-8 gap-4 px-2">
        <Button
          ...
          className="rounded-full px-6 border-white/10 font-sans text-sm text-[#9BB0C1]"
        >
        ...
        {currentStep < STEPS.length ? (
          <Button
            ...
            className="rounded-full px-8 bg-[#C09A6F] hover:bg-[#A07B53] font-sans text-sm text-white shadow-md hover:scale-105 transition-all duration-300"
          >
            Siguiente
          ...
          <Button
            ...
            disabled={isSubmitting}
            className="rounded-full px-8 bg-[#C09A6F] hover:bg-[#A07B53] font-sans text-sm text-white shadow-md hover:scale-[1.03] transition-all duration-300"
          >
            {isSubmitting ? (
              <>
