      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-6 space-y-6">
            <div className="inline-flex items-center gap-2 bg-[#B76E4D]/10 border border-[#B76E4D]/25 px-4 py-1.5 rounded-full text-xs font-semibold text-[#B76E4D] uppercase tracking-wider font-sans">
